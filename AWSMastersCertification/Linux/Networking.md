...
- A SSH session works in two stages:
  1. TO sync the encryption to be used from any further communication
  2. to authenticate the user for access rights to be given
...
- When TCP connection is started, a session key is generated using diffie-Hellman algorythm
- Process for Diffie Hellman:
