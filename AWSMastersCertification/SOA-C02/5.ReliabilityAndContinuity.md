...
- **Advantages**:
  - Simplifies updates to components.
  - Reduces dependencies and creates more autonomous components.
  - Enables non-blocking operations, enhancing fault tolerance.
  - Provides scalability by breaking down systems logically.
