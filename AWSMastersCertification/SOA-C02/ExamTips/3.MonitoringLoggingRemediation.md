...
## EventBridge 
- Allows you to easily configure event-driven systems and define tasks that can be run on a pre0defines schedule.
...
- **Rule** match events and route them to the correct target.
