...
>
> [Alternative Guide](https://bizanosa.com/install-kubernetes-with-kubeadm/)
...
#### Adjust hosts file
Edit hosts file and add IP address of each host followed by host's name to the file:
```sh
192.168.60.11 master01
```
...
```sh
sudo kubeadm init --apiserver-advertise-address 192.168.60.10 --control-plane-endpoint 192.168.60.10
```
