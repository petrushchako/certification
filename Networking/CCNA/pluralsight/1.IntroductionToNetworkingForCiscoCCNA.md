...
Cisco offers **five certification levels**:

| Level | Example Certifications | Focus |
|-------|------------------------|-------|
| Entry        | **CCT Data Center** (Cisco Certified Technician) | Basic troubleshooting in Cisco data center (NX-OS, ACI). <br> *Note: CCENT retired.* |
| Associate    | **CCNA** (network fundamentals) <br> **DevNet Associate** (automation, programmability) <br> **CyberOps Associate** (security) | Foundational networking, automation, or security skills. |
| Professional | **CCNP** (Enterprise, Security, Data Center, Collaboration, Service Provider) <br> **DevNet Professional** | Deeper expertise in routing/switching, security, DC, SP, or automation. |
| Expert       | **CCIE** (Enterprise, Wireless, Data Center, Security, Service Provider) <br> **Design Expert** | High-level design, complex troubleshooting, protocol mastery. |
| Architect    | **Cisco Certified Architect** | No exam – board interview validating advanced design & implementation experience.    |

### CCNA Exam Objectives
- Current exam: **200-301** (since Feb 24, 2020).
- Covers all fundamental networking areas (IP addressing, routing, switching, security, automation, services).
- Recommendation: download the **official exam objectives** and check off each as you study.
- Some questions may come from *“hidden topics”* in the objectives.

### Key Takeaways
- Cisco certifications progress from **Entry → Associate → Professional → Expert → Architect**.
- **CCNA (200-301)** is the current Associate-level certification and foundational for networking careers.
- Prepare using **multiple learning styles**: videos, books, labs.
- **Hands-on practice** is essential – either with real gear, Packet Tracer, or GNS3.